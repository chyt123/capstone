...
public class LocalFileStorage {
    ...
    public static String ITEM_SET_BY_USER = "item-set-by-user.dat";
    public static String ITEM_SET_BY_USER_CLICK = "item-set-by-user-click.dat";
    public static String USER_SET_BY_ITEM = "user-set-by-item.dat";
    public static String USER_SET_BY_ITEM_CLICK = "user-set-by-item-click.dat";
    public static String ITEM_SIMILARITY = "item-similarity.dat";
